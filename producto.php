<?php
    ...
    if (isset($_GET['id'])) {
        ...
        $codigo_producto = $row['codigo_producto']; // Obtener el código del producto
    } else {
    ...
    if (isset($_POST['reference_remove']) && isset($_POST['quantity_remove'])) {
        ...
        // Registrar la acción de eliminar stock
